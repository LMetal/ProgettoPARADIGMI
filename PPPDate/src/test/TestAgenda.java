...
public class TestAgenda {
    ...
    void testModificaData() throws AppuntamentoException, AgendaException {
        ...
        a0.add("02-01-2023", "10-20", 60, "Leo", "");
        ...
        assertEquals(new Appuntamento("02-01-2023", "10-20", 60, "Leo", "").toString(), a0.iterator().next().toString());


        Agenda a1 = new Agenda("");

        a1.add("02-01-2022", "10-20", 60, "Leo", "");
        a1.modificaData(0, "01-01-2022");
        Iterator<Appuntamento> iter1 = a1.iterator();

        Appuntamento check = new Appuntamento("01-01-2022", "10-20", 60, "Leo", "");
        ...
        check = new Appuntamento("02-11-2022", "10-20", 60, "Leo", "");
    ...
    void testModificaOra() throws AppuntamentoException, AgendaException {
        ...
        Appuntamento check = new Appuntamento("01-01-2022", "09-20", 60, "Leo", "");
        ...
        check = new Appuntamento("01-01-2022", "22-30", 60, "Leo", "");
    ...
    void testModificaDurata() throws AppuntamentoException, AgendaException {
        ...
        a0.add("02-01-2023", "09-20", 60, "Leo", "");
    ...
    void testModificaNome() throws AppuntamentoException, AgendaException {
        Agenda a0 = new Agenda("");
        a0.add("02-01-2023", "10-20", 60, "Alan Parson", "");
        a0.add("02-01-2023", "22-20", 60, "Sting", "");
    ...
    @Test
    void scriviFile() throws FileNotFoundException, AppuntamentoException, AgendaException {
    	Agenda a1 = new Agenda("foo");
    	a1.add("01-01-2022", "10-20", 60, "Leo", "");
        a1.add("02-01-2022", "11-30", 60, "Leo", "ufficio");
