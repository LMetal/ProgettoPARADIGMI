...
public class Interfaccia {
    ...
    private static void scriviSuFile() throws IOException {
        ...
        sceltaAgenda("Che agenda scrivere su file? ").scriviAgenda();
    }
...
class metodiAgenda{
    ...
    static void visualizzaAgenda(Agenda a, boolean wait){
