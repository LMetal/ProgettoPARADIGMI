...
public class TestAgenda {
    ...
    @Test
    void testAddNumApp() throws AppuntamentoException, AgendaException {
        ...
        Agenda a3 = new Agenda("a3");
        assertEquals(0, a3.numApp());
        Appuntamento ap1 = new Appuntamento("01-02-2023", "12-25", 10, "Andrea", "stazione");
        Appuntamento ap2 = new Appuntamento("11-02-2023", "17-00", 240, "Lorenzo", "ufficio");

        a3.add(ap1);
        assertEquals(1, a3.numApp());
        a3.add(ap2);
        assertEquals(2, a3.numApp());
    ...
    @Test
    void testNomeUguale(){
        Agenda agenda1 = new Agenda("famiglia");
        Agenda agenda2 = new Agenda("lavoro");

        Agenda a1 = new Agenda("famiglia");
        Agenda a2 = new Agenda("lavoro");
        Agenda aBlank = new Agenda("");

        assertFalse(agenda1.compareNome(a2));
        assertTrue(agenda1.compareNome(a1));

        assertTrue(agenda2.compareNome(a2));
        assertFalse(agenda2.compareNome(a1));
        assertFalse(agenda2.compareNome(aBlank));
    }
    ...
    void testModificaData() throws AppuntamentoException, AgendaException {
        ...
        assertEquals("Formato data invalido <dd-mm-yyyy>", exApp.getMessage());
    ...
    void testModificaDurata() throws AppuntamentoException, AgendaException {
        ...
        AgendaException ex = assertThrows(AgendaException.class, () -> a0.modificaDurata(0, 120));
        assertEquals("Presente sovrapposizione\nAppuntamento non modificato", ex.getMessage());
        assertEquals(2, a0.numApp());
