...
public class TestAppuntamento {
    ...
    void testCompareTo() throws AppuntamentoException {
        ...
        assertEquals(ap1.inizio().compareTo(ap2.inizio()), ap1.compareTo(ap2));
        assertEquals(ap2.inizio().compareTo(ap1.inizio()), ap2.compareTo(ap1));

        assertEquals(ap1.inizio().compareTo(ap2.inizio()), ap4.compareTo(ap2));

        assertEquals(ap3.inizio().compareTo(ap2.inizio()), ap3.compareTo(ap2));
    }
